...
func field_Subscription_messagePosted_args(rawArgs map[string]interface{}) (map[string]interface{}, error) {
	args := map[string]interface{}{}
	var arg0 string
	if tmp, ok := rawArgs["user"]; ok {
		var err error
...
func field_Subscription_userJoined_args(rawArgs map[string]interface{}) (map[string]interface{}, error) {
	args := map[string]interface{}{}
	var arg0 string
	if tmp, ok := rawArgs["user"]; ok {
		var err error
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Subscription.messagePosted":
		...
		args, err := field_Subscription_messagePosted_args(rawArgs)
		if err != nil {
			return 0, false
		}
	...
	case "Subscription.userJoined":
		...
		args, err := field_Subscription_userJoined_args(rawArgs)
		if err != nil {
			return 0, false
		}
...
func (ec *executionContext) _Subscription_messagePosted(ctx context.Context, field graphql.CollectedField) func() graphql.Marshaler {
	...
	//          and Tracer stack
	rctx := ctx
	results, err := ec.resolvers.Subscription().MessagePosted(rctx, args["user"].(string))
	if err != nil {
		ec.Error(ctx, err)
		return nil
	}
...
func (ec *executionContext) _Subscription_userJoined(ctx context.Context, field graphql.CollectedField) func() graphql.Marshaler {
	...
	//          and Tracer stack
	rctx := ctx
	results, err := ec.resolvers.Subscription().UserJoined(rctx, args["user"].(string))
	if err != nil {
		ec.Error(ctx, err)
		return nil
	}
